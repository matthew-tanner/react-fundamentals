    ...
    <Container className="main">
      <Row>
        <Col xs="12">
          ...
          <p>Functional components are the primary tool in React</p>
          <dl>
            <dt>Can use state</dt>
            <dd>
              With the 'useState' hook, functional components can now both render a display and
              update the info
            </dd>
            <dt>No 'this' keyword</dt>
            <dd>
              Older class components in react use 'this'. functional components have no 'this'
              object.
            </dd>
            <dt>Can use effects</dt>
            <dd>
              With the 'useEffect' hook, functional components can perform side effects with any
