    ...
    <div className="main">
      <div className="mainDiv">
        <ul>
          ...
          <dd>Class components have a separate means of using and chanign state</dd>
          ...
          <dd>Like with props changes, changing the state of a complent re-renders the whole component</dd>
        </ul>
        <StateExample />
      </div>
    </div>
